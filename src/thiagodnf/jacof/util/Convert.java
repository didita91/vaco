...
//        Preconditions.checkArgument(array.length != 0, "The array cannot be empty");
        if (array == null) {
            System.err.println("The array cannot be null");
        }
        if (array.length == 0) {
            System.err.println("The array cannot be empty");
        }
    ...
    public static double[][] toDoubleMatrix(String[][] matrix) {
        ...
        if (matrix == null) {
            System.err.println("The matrix cannot be null");
        }
...
//        Preconditions.checkArgument(matrix.length > 0, "The matrix cannot be zero");
        ...
        if (matrix.length < 0) {
            System.err.println("The matrix cannot be zero");
        }
