...
/**
 * This class represents the subset of ants used to evaporate or deposit values
 * in the pheromone matrix. All kind of subset should implement this class.
 *
...
//	static final Logger LOGGER = Logger.getLogger(AbstractSubSet.class);
    ...
    public AbstractSubSet(ACO aco) {
        ...
        if (aco == null) {
            System.err.println("The aco cannot be null");
        }
        this.aco = aco;
    }

    /**
     * Get the list of ants that will be used to evaporate or deposit the
     * pheromone in the pheromone graph
     *
