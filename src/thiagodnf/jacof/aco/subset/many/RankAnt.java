...
//		checkArgument(rank <= aco.getNumberOfAnts(), 
//                        "The rank should be greater or equal than the number of ants");
		if(rank<0){
                System.err.println("The rank should be greater or equal than 0.0");
                }
                if(rank>aco.getNumberOfAnts()){
                System.err.println("The rank should be greater or equal than the number of ants");
                }
		this.rank = rank;
	}
