...
/**
 * This class represents how an ant builds its tour. Currently, this framework
 * support two possible ant exploration:
 * <br><br>
 * 1) AS algorithm; <br>
 * 2) ACS algorithm
 *
...
//        checkNotNull(antSelection, "The antSelection cannot be null");
        ...
        if (antSelection ==null) {
            System.err.println("The antSelection cannot be null");
    ...
    /**
     * Given that an ant is in given node, this method returns the next node
     *
