...
public class AnAntAtARandomVertex extends AbstractAntInitialization {
    ...
    public AnAntAtARandomVertex(ACO aco) {
     ...
     //   checkArgument(aco.getNumberOfAnts() >= 1, "The number of ants should be greater or equal than 1");
        if (aco.getNumberOfAnts() < 1) {
            System.err.println("The number of ants should be greater or equal than 1");
        }
...
if(antId<0){
System.err.println("The ant's id should be greater or equal than 0");
}
if(antId >= aco.getNumberOfAnts()){
System.err.println("The ant's id should be less than the number of ants");
}
