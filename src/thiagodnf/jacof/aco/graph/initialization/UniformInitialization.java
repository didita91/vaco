...
/**
 * Pheromone initialization for a range [minValue:maxValue]. A random number
 * will be chosen taking into consideration this range
 *
...
public class UniformInitialization extends AbstractGraphInitialization {
    ...
    public UniformInitialization(ACO aco, double minValue, double maxValue) {
        ...
        if (minValue > maxValue) {
            System.err.println("The minValue should be less or equal than maxValue");
        }
