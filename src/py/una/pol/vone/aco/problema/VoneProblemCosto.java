 ...
 */
public class VoneProblemCosto extends Problem {
    ...
    public VoneProblemCosto(List<NodosFisicosCandidatos> lista, SustrateNetwork redFisic, VirtualNetwork redVirt) throws IOException {
        listaNodos = lista;
        redFisica = redFisic;
        redVirtual = redVirt;
                    ...
                    for (VirtualEdge ev : redVirtual.getEnlacesVirtuales()) {
                        if ((ev.getNodoUno().getIdentificador() == nodoOrigen && ev.getNodoDos().getIdentificador() == nodoDestino)
                            ...
                            try {
                                ...
                                Logger.getLogger(VoneProblemCosto.class.getName()).log(Level.SEVERE, null, ex);
                            }
    ...
    public final double evaluate(int[] solution) {
        ...
        try {
            totalDistance = obtenerDistanciaSolucion(solution);
        } catch (CloneNotSupportedException ex) {
            Logger.getLogger(VoneProblemCosto.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public String toString() {
        return VoneProblemCosto.class.getSimpleName();
    }
